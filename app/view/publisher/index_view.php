<div id="right">
  <h2>Sách Theo Nhà Xuất Bản</h2>
  <section class="grid-holder features-books">
  <?php foreach ($listBookByPB as $key => $b) : ?>
      <figure class="span4 slide first chinh1">
          ...
          <p>Thể loại:
            <a class="nxb" href="?cn=typebook&m=index&idType=<?php echo $b['id_loai']; ?>"><?php echo $b['TenLoai']; ?></a>
          </p>
          <p>Tác giả:
            <a class="nxb" href=""><?php echo $b['TenTG']; ?></a>
          </p>
          <p>Nhà xuất bản:
            <a class="nxb" href="?cn=publisher&m=index&idPB=<?php echo $b['id_nxb']; ?>" style="background-color: red;"><?php echo $b['TenNXB']; ?></a>
          </p>
