<div id="right">
  ...
  <?php foreach ($dataBook as $key => $b) : ?>
      <figure class="span4 slide first chinh1">
          ...
          <p>Thể loại:
            <a class="nxb" href="?cn=typebook&=index&idType=<?php echo $b['id_loai']; ?>"><?php echo $b['TenLoai']; ?></a>
          </p>
          <p>Tác giả:
            <a class="nxb" href=""><?php echo $b['TenTG']; ?></a>
          </p>
          <p>Nhà xuất bản:
            <a class="nxb" href="?cn=publisher&m=index&idPB=<?php echo $b['id_nxb']; ?>"><?php echo $b['TenNXB']; ?></a>
          </p>
